...
void main() {
  ...
  setUp(() {
    mockHttpClient = MockHttpClient();
    dataSourceImplementation = NumberTriviaRemoteDataSourceImplementation(client: mockHttpClient);
  });
  ...
  group('getConcreteNumberTrivia', () {
    ...
    test(
      'should preform a GET request on a URL with number being the endpoint and with application/json header',
        ...
        // act
        dataSourceImplementation.getConcreteNumberTrivia(tNumber);
        // assert
    ...
    test(
      'should return NumberTrivia when the response code is 200 (success)',
        ...
        setUpMockHttpClientSuccess200();
        // act
        final result = await dataSourceImplementation.getConcreteNumberTrivia(tNumber);
        // assert
    ...
    test(
      'should throw a ServerException when the response code is 404 or other',
        ...
        // act
        final call = dataSourceImplementation.getConcreteNumberTrivia;
        // assert
  ...
  group('getRandomNumberTrivia', () {
    ...
    test(
      'should throw a ServerException when the response code is 404 or other',
        ...
        setUpMockHttpClientFailure404();
        // act
        final call = dataSourceImplementation.getRandomNumberTrivia;
        // assert
